...
<template lang="">
    ...
    <section class="about-two">
        <div
            class="about-two_pattern-two"
            style="
                background-image: url(./../../public/images/background/pattern-13.png);
            "
        ></div>
        <div class="auto-container">
            <div class="row clearfix">
                <!-- Content Column -->
                <div
                    class="about-two_image-column col-lg-6 col-md-12 col-sm-12"
                >
                    <div
                        class="about-two_pattern-one"
                        style="
                            background-image: url(./../../public/images/background/pattern-12.png);
                        "
                    ></div>
                ...
                <div class="about-two_content col-lg-6 col-md-12 col-sm-12">
                    <div class="about-two_content-inner">
                        ...
                        <div class="about-two_text">
                            ...
                            at all times is like a plumber who fixes your pipes;
                            that’s what they are supposed to do. Many IT firms
                            struggle.
                        </div>
                        <div class="about-two_feature">
                            <div class="row clearfix">
                                <!-- About Two Block -->
                                <div
                                    class="about-two_block col-lg-6 col-md-6 col-sm-6"
                                >
                                    <div class="about-two_block-inner">
                                        <span class="about-two_block-icon">
                                            <img
                                                src="./../../public/images/icons/about-1.png"
                                                alt=""
                                            />
                                        </span>
                                ...
                                >
                                    <div class="about-two_block-inner">
                                        <span class="about-two_block-icon">
                                            <img
                                                src="./../../public/images/icons/about-2.png"
                                                alt=""
                                            />
                                        </span>
                                        <h6 class="about-two_block-heading">
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="about-phone_box">
                                <span
                                    class="about-phone_icon fa-solid fa-phone fa-fw"
                                ></span>
                                Call for help <br />
                                <a
                                    class="about-two_phone-number"
