...
<template lang="">
  ...
  <section class="counter-one">
    <div class="auto-container">
      <div
        class="counter-one_inner-container"
        style="background-image: url(./../../mages/background/1.jpg)"
      >
        <div class="row clearfix">
          ...
          <div class="counter-one_block col-lg-3 col-md-6 col-sm-6">
            <div class="counter-one_inner">
              ...
              <div class="counter-one_counter">
                <span class="odometer" data-count="105"></span>+
              </div>
          ...
          <div class="counter-one_block col-lg-3 col-md-6 col-sm-6">
            <div class="counter-one_inner">
              ...
              <div class="counter-one_counter">
                <span class="odometer" data-count="10"></span>K+
              </div>
          ...
          <div class="counter-one_block col-lg-3 col-md-6 col-sm-6">
            <div class="counter-one_inner">
              ...
              <div class="counter-one_counter">
                <span class="odometer" data-count="850"></span>k+
              </div>
